...
for i in range(num_models):
    for event in events:
        ...
        if model == 'cnn':
            ...
            predictions,predictions2,history = train_and_predict_cnn_save(model,event,modelParams,directory)
            ...
            predictions,predictions2,history = train_and_predict_dnn_save(model,event,
            ...
            predictions,predictions2,history = train_and_predict_rnn_save(model,event,modelParams,directory)
