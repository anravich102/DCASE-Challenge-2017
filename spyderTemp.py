...
def spec(data,sr, model):
    ...
    D = np.abs(librosa.stft(data + eps,
                                      ...
                                      hop_length=int(0.02*44100),
                                      center = False))**2
    S = librosa.feature.melspectrogram(S=D, n_mels = 64)
...
check = slice_array_new(spec, 'cnn', context = 7)
print(check.shape)
#==============================================================================
# spec  = spec(y,sr, model = 'cnn')
# print(spec.shape)
...
#==============================================================================
# h5f = h5py.File('X_train_preprocessed.h5', 'w')
# h5f.create_dataset('X_train', data=X_train)
# h5f.close()
#==============================================================================

#==============================================================================
# myfile = h5py.File('testh5.h5', 'w')
# #myfile = 'testh5.h5'
# dset = myfile.create_dataset("features", x , maxshape=(None, 1025, 7))
# #dset.shape
# myfile.close()
# 
#==============================================================================
...
# 
# import h5py
# f = h5py.open_file("mytestfile.hdf5", "w")
#==============================================================================
